...
public interface PersonRepository extends BasePagingAndSortingReadOnlyRepository<Person, String>, PersonRepositoryCustom {
	/**
	 * Returns a single Person object based on primary key.
	 * This method must exist in the Repository, or the URI for a specific Person will receive a 405 response.
	 * @param personId
	 * @return
	 */
